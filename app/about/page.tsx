...
const leadership = [
  {
    ...
    role: "Senior Pastor",
    bio: "Pastor John has been leading Grace Community Church for over 15 years. He holds a Master of Divinity from Seminary University and is passionate about expository preaching and discipleship.",
    image: "/placeholder.svg?height=300&width=300",
  },
  {
    name: "Elder Mary Johnson",
    role: "Associate Pastor",
    bio: "Elder Mary oversees our women's ministry and counseling programs. She has a heart for helping others grow in their faith and find healing through Christ.",
    image: "/placeholder.svg?height=300&width=300",
  },
  {
    name: "David Martinez",
    role: "Worship Leader",
    bio: "David leads our music ministry with a passion for creating an atmosphere of worship. He has been serving in music ministry for over 10 years.",
    image: "/placeholder.svg?height=300&width=300",
  },
  {
    name: "Sarah Wilson",
    role: "Youth Pastor",
    bio: "Sarah is dedicated to helping young people develop a strong foundation in faith. She organizes youth programs, camps, and mentorship opportunities.",
    image: "/placeholder.svg?height=300&width=300",
  },
]
              ...
              >
                <Card className="h-full border-none shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-slate-800 mb-1">{leader.name}</h3>
