        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Create New Position</h1>
                <p className="text-sm sm:text-base text-slate-600 mt-1 sm:mt-2">Add a new church position or role</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 w-full sm:w-auto order-1 sm:order-2"
              >
                {saving ? (
                  <>
